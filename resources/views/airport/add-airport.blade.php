...
<div class="container-fluid pt-4 px-4"><div class="text-center"><h2 class="mb-4">Add Airport</h2></div>
    <div class="col">
        <div class="bg-light rounded h-100 p-4">
            ...
            <form method="POST" enctype="multipart/form-data" id="dataform">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="name" name="name" placeholder="Enter Airport Name" required>
                    </div>
                </div>
                    <div class="col-sm-6">
                        <label for="contact" class="col-sm-3 col-form-label">Contact Number</label>
                        <div class="col-sm-10">
                            <input type="number" class="form-control" id="contact" name="contact" placeholder="Enter Phone No." minlength="10" maxlength="10" required>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="address" name="address" placeholder="Enter Airport's Address" required>
                    </div>
                    </div>
                    <div class="col-sm-4">
