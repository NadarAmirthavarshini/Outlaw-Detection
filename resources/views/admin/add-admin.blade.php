...
<div class="container-fluid pt-4 px-4"><div class="text-center"><h2 class="mb-4">Add Admin</h2></div>
    <div class="col">
        <div class="bg-light rounded h-100 p-4">
            ...
            <form method="POST" enctype="multipart/form-data" id="dataform">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="fname" name="fname" placeholder="Enter Admin's First Name" onkeydown="return /[a-z]/i.test(event.key)" minlength="3" required>
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="lname" name ="lname" placeholder="Enter Admin's Last Name">
                    </div>
                </div>
                ...
                <div class="row mb-4">
                    <div class="col-sm-6">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control" id="age" name="age" placeholder="Enter Admin's Age" min=18 max=80 required>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <label for="contact" class="col-sm-2 col-form-label">Contact Number</label>
                        <div class="col-sm-10">
                            <input type="number" class="form-control" id="contact" name="contact" placeholder="Enter Admin's Phone No." minlength="10" maxlength="10" required>
                ...
                <fieldset class="row mb-4">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control" id="aadhar" name ="aadhar" placeholder="Enter Admin's Aadhar No" required>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="address" name="address" placeholder="Enter Admin's Address" required>
                    </div>
                    </div>
                    <div class="col-sm-4">
